...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <style type="text/css">
        ...
        #templateHeader{
            ...
            background-image:url("https://cdn-images.mailchimp.com/template_images/gallery/bg-leaves.jpg");
    ...
    <body>
<span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Resetea la contraseña aqui...</span>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <div style="text-align: center;">Dale click al link para cambiar la contraseña</div>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 20px; padding: 15px;">
                                <a class="mcnButton " title="Click Aquí" href="{{route('password.reset',['token' => $token])}}" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Click Aquí</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                            ...
                            <tr>
                                <td align="center" valign="top" id="templateMiddleBody" data-template-container>
                                    ...
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
                                        <tr>
                                            <td valign="top" class="middleBodyContainer"></td>
                                        </tr>
                                    </table>
